...
journey
    ...
    section Verificando última vacina
      Se questiona quando foi a última vacina dos pets: 3: Júlia
    ...
    section Agenda novo retorno
      ...
      Anota as datas em um pedaço de papel qualquer: 2: Júlia
    section Falta de acompanhamento
      Esquece o papel na gaveta e não se lembra de verificar: 1: Júlia
```

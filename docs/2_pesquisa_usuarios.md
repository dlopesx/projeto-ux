...
| **Questionário (Google Forms)** | Quantificar ferramentas usadas como agenda, identificar padrões de UX preferidos pelos usuários e expectativas sobre funcionalidades. | Divulgar o link em redes sociais (Instagram, fórum de pets do Reddit), aberto por 1 semana. Sem identificação pessoal, tempo estimado de resposta de 5 - 8 min. | `https://docs.google.com/forms/d/e/1FAIpQLSdRHnFlhb7RvL2AnUvdgYeF40ZVz56V6EgdtMXFqYsfxHsKQw/viewform?usp=header` |
| **Investigação contextual** | Observar como o tutor administra atividades do dia a dia com cuidados do pet e outras atividades. | Visita ao tutor para realizar observação enquanto registra as dificuldades relatadas e comportamento usual. |Pontos de observação: quais ferramentas o participante usa para administrar a rotina do pet; se há esquecimento ou duplicidade nas ações; se alguém participa do processo; fazer perguntas como "por que você faz assim?" ou "isso é sempre assim ou varia?" |
